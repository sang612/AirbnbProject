...
import { getTicketById, updateTicket } from "../../../slices/ticket";
...
const EditTicket = () => {
  ...
  const formik = useFormik({
    ...
    initialValues: {
      id: id,
      checkIn: ticketDetail?.checkIn,
      checkOut: ticketDetail?.checkOut,
      userId: ticketDetail?.userId?._id,
      roomId: ticketDetail?.roomId?._id,
    },
    onSubmit: (values) => {
      console.log(values);
