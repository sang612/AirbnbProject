  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 register">
      <div className="px-8 py-6 mx-4 mt-4 text-left bg-white shadow-lg md:w-1/3 lg:w-1/3 sm:w-1/3">
        ...
        <h3 className="text-2xl font-bold text-center">Đăng Ký Thành Viên</h3>
        <form onSubmit={handleSubmit(handleSubmitSignUp)}>
          <div className="mt-4">
              ...
              <label className="block" htmlFor="Name">
                ...
                <label>
                  <select
                    ...
                    id="countries"
                    className=" border border-back-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                  >
            ...
            <div className="mt-6 text-grey-dark">
              Đã có tài khoản?
              <Link className="login-link hover:underline" to="/login">
                &nbsp;Đăng nhập
              </Link>
            </div>
          </div>
